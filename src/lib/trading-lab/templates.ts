...
export const STRATEGY_TEMPLATES: Record<string, StrategyVersionInput & { templateId: string; entryMode: "swing" | "reversal" | "momentum" }> = {
  swing: {
    ...
    longEntry: { logic: "all", conditions: [{ id: "trend-long", left: "ema_20", operator: "crosses_above", right: "ema_50", timeframe: "1h", completedCandleOnly: true }] },
    shortEntry: { logic: "all", conditions: [{ id: "trend-short", left: "ema_20", operator: "crosses_below", right: "ema_50", timeframe: "1h", completedCandleOnly: true }] },
  ...
  reversal: {
    ...
    longEntry: { logic: "all", conditions: [{ id: "oversold", left: "rsi_14", operator: "lt", right: 32, timeframe: "15min", completedCandleOnly: true }] },
    shortEntry: { logic: "all", conditions: [{ id: "overbought", left: "rsi_14", operator: "gt", right: 68, timeframe: "15min", completedCandleOnly: true }] },
  ...
  momentum: {
    ...
    timeframes: { context: ["4h", "1h"], setup: "15min", trigger: "5min" },
    longEntry: { logic: "all", conditions: [{ id: "breakout-long", left: "close", operator: "gt", right: "rolling_high_20", timeframe: "15min", completedCandleOnly: true }] },
    shortEntry: { logic: "all", conditions: [{ id: "breakout-short", left: "close", operator: "lt", right: "rolling_low_20", timeframe: "15min", completedCandleOnly: true }] },
